...
## <div dir="rtl">درخواست وارد شدن (Login) کاربر به کیت توسعه‌دهندگان سیبچه</div>
...
## <div dir="rtl">درخواست خارج شدن (Logout) کاربر از کیت توسعه‌دهندگان سیبچه</div>
...
## <div dir="rtl">گرفتن اطلاعات کاربر فعلی</div>
